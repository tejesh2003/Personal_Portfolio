...
const Profiles = () => {
  ...
  const resumeDownloadLink =
    "https://drive.google.com/uc?export=download&id=1p-iSE0PU1_uohgH_A7AbUW8kHHWdiiBc";
  const resumeViewLink =
    "https://drive.google.com/file/d/1p-iSE0PU1_uohgH_A7AbUW8kHHWdiiBc/view?usp=sharing";
    ...
    >
      ...
      <div className="w-full lgl:w-3/12">
        <div className="mt-6 lgl:mt-14 w-full h-[600px] border-l-[6px] border-l-black border-opacity-30 flex flex-col gap-10">
          ...
          <ProfileCard
            title="LinkedIn"
            link="https://www.linkedin.com/in/tejesh-chintada/"
          />
          <ProfileCard
            title="LeetCode"
            link="https://leetcode.com/u/Tejesh_2003/"
          />
          <ProfileCard
            title="GFG"
            link="https://www.geeksforgeeks.org/user/tejeshchintada22/"
          />
          <ProfileCard
            title="CodeChef"
            link="https://www.codechef.com/users/tejesh_22"
          />
        </div>
      </div>
